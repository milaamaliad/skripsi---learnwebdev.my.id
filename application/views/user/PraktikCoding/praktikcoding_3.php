...
<body>
  ...
  <p>Untuk lebih memahamai Format Formulir Pada Halaman Web silahkan edit dan belajar pada page ini dan pahami materi di Page Materi</p><br> 

Nama : <input type="text" name="nama"><br>

Jenis Kelamin : <br>
<input type="radio" id="jk" name="jenis_kelamin" value="laki_laki">laki-laki<br>
<input type="radio" id="jk" name="jenis_kelamin" value="perempuan">perempuan<br>

Hobi:<br>
<input type="checkbox" id="hobi1" name="hobi1" value="berenang">berenang<br>
<input type="checkbox" id="hobi1" name="hobi1" value="membaca">membaca<br>
      ...
      <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body p-4">
            <p>1. Pastikan Anda telah membaca dan memahami <a href="<?= base_url('materi/materi_form_1'); ?>">materi Format Formulir Pada Halaman Web</a> </p>
